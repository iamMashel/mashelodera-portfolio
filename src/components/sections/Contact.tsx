...
export function Contact() {
  return (
    <section id="contact" className="surface-deep surface-deep-tex scroll-mt-20">
      <div className="container-page section-pad">
        <Reveal>
          <p className="font-mono text-sm text-accent-bright">
            {site.availabilityNote}
          </p>
          <h2 className="mt-4 max-w-2xl font-display text-[clamp(2.25rem,5vw,4rem)] font-semibold leading-[1.02] tracking-tight">
            Let&apos;s build something useful.
          </h2>
          <p className="mt-6 max-w-xl text-lg text-cream-muted">
            An AI feature, an agent, a dashboard, a model-eval pipeline, or a team
            that wants to level up. Tell me what you&apos;re working on. I usually
            reply within a day.
          </p>
        </Reveal>
        ...
        <Reveal>
          <div className="mt-12 grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:gap-14">
            ...
            <div>
              ...
              <p className="mt-8 font-mono text-xs uppercase tracking-wider text-accent-bright">
                Or find me here
              </p>
                  ...
                  <li key={label} className="w-full border-t border-cream/15 first:border-t-0">
                    <a
                      ...
                      {...(href.startsWith("http")
                        ...
                        : {})}
                      className="group flex items-center justify-between gap-6 py-3 text-cream-muted transition-colors hover:text-cream"
                    >
